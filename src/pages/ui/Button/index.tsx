...
interface ButtonsState {
  loading_first: boolean
  loading_secend: boolean
  size?: ButtonSize
}
    ...
    return (
      <div>
        ...
        <Card title="加载按钮" className="content-margin">
          ...
          <Button
            type="primary"
            loading={this.state.loading_first}
            onClick={() => {
              this.setState({ loading_first: true, loading_secend: false })
            }}
          >
            Click me!
          </Button>
          <Button
            type="primary"
            icon="poweroff"
            loading={this.state.loading_secend}
            onClick={() => {
              this.setState({ loading_first: false, loading_secend: true })
            }}
          >
            Click me!
          </Button>
